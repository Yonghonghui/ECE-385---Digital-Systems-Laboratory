...
//u32 selectslavemask=0x00000000;
//u32 deselectslavemask=0x00000001;
...
//	XSpi_SetSlaveSelect(&SpiInstance, SpiInstance.SlaveSelectMask);//select MAX3421E
	XSpi_SetSlaveSelectReg(&SpiInstance,0x000000000);
//	xil_printf("slave select mask: %lu\n",XSpi_GetSlaveSelectReg(&SpiInstance));
	...
	XSpi_SetSlaveSelectReg(&SpiInstance, 0x00000001);
	//XSpi_SetSlaveSelectReg(&SpiInstance, deselectslavemask); //mask=1
	return;
...
//	XSpi_SetSlaveSelect(&SpiInstance, SpiInstance.SlaveSelectMask);//select MAX3421E
	...
	writeStatus=XSpi_Transfer(&SpiInstance,writebuffer,NULL,nbytes+1);
	if(writeStatus!=XST_SUCCESS){
		xil_printf ("error\n");
	}
	XSpi_SetSlaveSelect(&SpiInstance, 0x00000000);
	XSpi_SetSlaveSelectReg(&SpiInstance, 0x00000001);
//		XSpi_SetSlaveSelectReg(&SpiInstance, deselectslavemask);
	return data+nbytes;
}
...
BYTE MAXreg_rd(BYTE reg) {
	...
	//return val
//	XSpi_SetSlaveSelect(&SpiInstance,SpiInstance.SlaveSelectMask); //select MAX3421E
//	xil_printf ("reached MAXreg_rd function\n");
	XSpi_SetSlaveSelectReg(&SpiInstance,0x000000000);
	XSpi_SetSlaveSelect(&SpiInstance, 0x00000001);
...
BYTE* MAXbytes_rd(BYTE reg, BYTE nbytes, BYTE* data) {
	...
	//return (data + nbytes);
//	XSpi_SetSlaveSelect(&SpiInstance,SpiInstance.SlaveSelectMask); //select MAX3421E
//	xil_printf ("reached MAXbytes_rd function\n");
	XSpi_SetSlaveSelectReg(&SpiInstance,0x000000000);
	XSpi_SetSlaveSelect(&SpiInstance, 0x00000001);
