...
ISEStep( "vivado",
         "-log blk_mem_gen_single_basketball_bombed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_single_basketball_bombed.tcl" );
